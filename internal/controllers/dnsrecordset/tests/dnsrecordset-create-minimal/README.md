# Create a DNSRecordset with the minimum options

## Step 00

Create a minimal DNSRecordset, that sets only the required fields, and verify that the observed state corresponds to the spec.
