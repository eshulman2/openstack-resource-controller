...
// Fundamental types
type (
	orcObjectT     = orcv1alpha1.DNSRecordset
	orcObjectListT = orcv1alpha1.DNSRecordsetList
	resourceSpecT  = orcv1alpha1.DNSRecordsetResourceSpec
	filterT        = orcv1alpha1.DNSRecordsetFilter
)
